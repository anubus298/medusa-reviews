...
export const listStoreProductReviewsQuerySchema = paginationSchema.extend({
...
export type UpsertProductReviewsSchema = z.infer<
  typeof upsertProductReviewsSchema
>;
...
export const storeProductReviewRoutesMiddlewares: MiddlewareRoute[] = [
  {
    ...
    middlewares: [
      validateAndTransformQuery(
        listStoreProductReviewsQuerySchema,
        defaultStoreReviewsQueryConfig
      ),
    ],
  },
  {
